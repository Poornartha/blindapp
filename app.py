...
def org():
    ...
    l1 = Label(frame0, text="Career Guidance For Science Students", fg="#0BB0F6", font=("Arial", 50, "bold")).place(
        x=30, y=30)
    l2 = Label(frame0,
               text="Which field are you more interested in? Engineering or Pure Sciences? Confused? Take a quiz?",
               fg="#0BB0F6", font=("times new roman", 20, "bold"))
    ...
    b1 = Button(frame0, text='Engineering', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                command=play).place(x=300, y=300)
    b2 = Button(frame0, text='Pure Sciences', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                command=org1).place(x=700, y=300)
    b3 = Button(frame0, text='Take a Quiz', fg="white", bg="#FFCD01", font="Helvetica 35 bold", relief="raised",
                command=quiz1).place(x=520, y=500)
    b4 = Button(frame0, text=" Quit ", fg="Black", font="Helvetica 20", relief="raised", command=quit).place(x=1200,
                                                                                                             y=600)
...
def org1():
    ...
    lz = Label(frameZ, text="Select the branch of pure science.", fg="#0BB0F6", font=("Helvetica", 30, "bold")).place(
        x=400, y=120)

    b181 = Button(frameZ, text='Physics', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                  command=physics).place(x=300, y=300)
    b182 = Button(frameZ, text='Maths', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                  command=maths).place(x=1000, y=300)
    b183 = Button(frameZ, text='Chemistry', fg="white", bg="#FFCD01", font="Helvetica 35 bold", relief="raised",
                  command=chemistry).place(x=300, y=400)
    b184 = Button(frameZ, text='Biology', fg="white", bg="green", font="Helvetica 35 bold", relief="raised",
                  command=biology).place(x=1000, y=400)
    b197 = Button(frameZ, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=org).place(x=1200,
                                                                                                            y=600)
...
def physics():
    ...
    l82 = Label(frameQ,
                ...
                fg="black", font=("Arial", 20)).place(x=400, y=300)
    b90 = Button(frameQ, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=org1).place(x=1200,
                                                                                                            y=600)


def voicePhy():
    engine.say(
        "Your options are: Geophysicst. Metallurgy. Ratiation Proctection. Research Scientist. Seismic Interpreter")
    engine.setProperty('rate', 150)
    engine.setProperty('volume', 1.0)
    engine.runAndWait()
...
def maths():
    ...
    l53 = Label(frameE, text="1.Operational Researcher\n2.Research Scientist\n3.Satistician\n4.Lecturer", fg="black",
                font=("Arial", 20)).place(x=400, y=300)
    b91 = Button(frameE, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=org1).place(x=1200,
                                                                                                            y=600)
...
def chemistry():
    ...
    l56 = Label(frameC,
                text="1.Clinical Biochemistry\n2.Foresic Scientist\n3.Pharmacologist\n4.Toxiologist\n5.Chemical Engineer\n6.Analytical Chemist",
                fg="black", font=("Arial", 20)).place(x=550, y=400)
    b92 = Button(frameC, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=org1).place(x=1200,
                                                                                                            y=600)


def voiceChem():
    engine.say(
        "Your options are: Clinical Biochemistry. Foresic Scientist. Pharmacologist. Toxiologist. Chemical Engineer. Analytical Chemist")
    engine.setProperty('rate', 150)
    engine.setProperty('volume', 1.0)
    engine.runAndWait()
...
def biology():
    ...
    l59 = Label(frameB,
                text="1.Soil Scientist\n2.Research Scientist (Life Sciences)\n3.Nature Conservation Officer\n4.Microbiologist",
                fg="black", font=("Arial", 20)).place(x=530, y=400)
    bV6 = Button(frameB, command=lambda: voiceBio()).place(x=100, y=200)
    b93 = Button(frameB, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=org1).place(x=1200,
                                                                                                            y=600)


def voiceBio():
    engine.say(
        "Your options are: Soil Scientist. Research Scientist (Life Sciences). Nature Conservation Officer. Microbiologist")
    engine.setProperty('rate', 150)
    engine.setProperty('volume', 1.0)
    engine.runAndWait()
...
def play():
    ...
    l4 = Label(frame, text="Choose a course to know more about it", fg="#0BB0F6",
               font=("times new roman", 20, "bold")).place(x=450, y=130)
    ...
    b6 = Button(frame, text='Computer Engineering', fg="white", bg="purple", font="Verdana 20", relief="raised",
                command=comp).place(x=510, y=170)
    b7 = Button(frame, text='Information Technology', fg="white", bg="#114762", font="Verdana 20", relief="raised",
                command=it).place(x=510, y=230)
    b8 = Button(frame, text='Electronics and Telecommunication', fg="white", bg="red", font="Verdana 20",
                relief="raised", command=extc).place(x=440, y=290)
    b9 = Button(frame, text='Civil Engineering', fg="white", bg="#FFEF00", font="Verdana 20", relief="raised",
                command=civ).place(x=545, y=350)
    b10 = Button(frame, text='Chemical Engineering', fg="white", bg="#00E6FF", font="Verdana 20", relief="raised",
                 command=chem).place(x=510, y=410)
    b11 = Button(frame, text='Biomedical Engineering', fg="white", bg="#FF0091", font="Verdana 20", relief="raised",
                 command=biomed).place(x=500, y=470)
...
def comC():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print('You said: ', format(com1))
            if (
                    com2 == "computer" or com2 == "computer science" or com2 == "computer science engineering" or com2 == "computer engineering"):
                comp()
...
def voiceHome2():
    engine.say(
        "Choose a course. Computer, Information Technology, Electronics and Telecommunication, Civil Engineering, Chemical Engineering, Biomedical Engineering")
    engine.setProperty('rate', 170)
    engine.setProperty('volume', 1.0)
    engine.runAndWait()
...
def it():
    ...
    b13 = Button(frame1, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
    ...
    l7 = Label(frame1,
               text="The curriculum for Information Technology Engineering is primarily designed to provide\n students with both the theoretical knowledge and technical skills. The curriculum also\n intends to improve a technological depth of knowledge and skills in analysis, design,\n implementation, and use of both information technology core skills and specialization skills. ",
               fg="black", font=("Arial", 20), anchor='w').place(x=190, y=200)
    l8 = Label(frame1, text="Job Profile:", fg="black", font=("Helvetica", 20, "bold")).place(x=10, y=350)
    l9 = Label(frame1,
               text="They design, develop, research and test software and digital\n hardware, digital devices and interfaces. So, various organizations are becoming more oriented\n to recruit IT engineers with a view to operate computer systems, software, servers,\n computer networking or network security.",
               fg="black", font=("Arial", 20), anchor='w').place(x=190, y=350)
    l10 = Label(frame1, text="Salary:", fg="black", font=("Helvetica", 20, "bold")).place(x=10, y=525)
    l11 = Label(frame1, text="$52000 to $59000 per annum", fg="black", font=("Arial", 20), anchor='w').place(x=190,
                                                                                                             y=525)
...
def comp():
    ...
    lC = Label(frameA,
               text="Computer engineering is a branch of engineering that integrates several fields of computer\n science and electronics engineering required to develop computer hardware and software.\n Computer engineers usually have training in electronic engineering (or electrical engineering),\n software design, and hardware–software integration instead of only software engineering or\n electronic engineering.",
               fg="black", font=("Helvetica", 20,)).place(x=190, y=250)
    lD = Label(frameA, text="Job Profile:", fg="black", font=("Helvetica", 20, "bold")).place(x=30, y=410)
    lE = Label(frameA,
               text="As a computer engineer, you're responsible for researching, designing, developing and\n testing computer hardware and equipment, including chips, analog sensors, circuit boards,\n keyboards, modems, routers and printers. You may work on the manufacturing\n of these components, as well as the installation.",
               fg="black", font=("Helvetica", 20,)).place(x=190, y=410)
    ...
    b13 = Button(frameA, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
...
def civ():
    ...
    b13 = Button(frame2, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
    ...
    l18 = Label(frame2, text="$50000 to $65000 per annum", fg="black", font=("Arial", 20), anchor='w').place(x=190,
                                                                                                             y=525)
...
def extc():
    ...
    b13 = Button(frameB, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
    ...
    lH = Label(frameB, text="ELECTRONICS & TELECOMMUNICATION ENGINEERING", fg="#0BB0F6",
               font=("Helvetica", 30, "bold")).place(x=200, y=120)
    ...
    lL = Label(frameB,
               text="As an electronics engineer you'll design, develop and test components, devices,\n systems or equipment that use electricity as part of their source of power.\n These components include capacitors, diodes, resistors and transistors",
               fg="black", font=("Arial", 20), anchor='w').place(x=190, y=375)
...
def chem():
    ...
    b14 = Button(frame3, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
...
def biomed():
    ...
    b14 = Button(frame4, text="Back", fg="Black", font="Helvetica 20", relief="raised", command=play).place(x=1200,
                                                                                                            y=600)
...
def quiz1():
    ...
    l65 = Label(frameE, text="1. Do you want to study about the \n practical application of Sciences.", fg="#0BB0F6",
                font=("Arial", 50, "bold")).place(x=200, y=30)

    b81 = Button(frameE, text='A. YES', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                 command=click1).place(x=300, y=400)
    b82 = Button(frameE, text='B. NO', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                 command=click2).place(x=1000, y=400)
    bCW = Button(frameE, command=comW).place(x=100, y=250)
    bVW = Button(frameE, command=lambda: voiceW()).place(x=100, y=200)
    b83 = Button(frameE, text="Next", fg="Black", font="Helvetica 20", relief="raised", command=quiz2).place(x=1000,
                                                                                                             y=550)
...
def quiz2():
    ...
    l66 = Label(frameF, text="2. Are you willing to study uptil \n you get you Ph.D degree?", fg="#0BB0F6",
                font=("Arial", 50, "bold")).place(x=200, y=30)
    bCX = Button(frameF, command=comX).place(x=100, y=250)
    b84 = Button(frameF, text='A. YES', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                 command=click3).place(x=300, y=400)
    b85 = Button(frameF, text='B. NO', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                 command=click4).place(x=1000, y=400)
    bVX = Button(frameF, command=lambda: voiceX()).place(x=100, y=200)
    b86 = Button(frameF, text="Next", fg="Black", font="Helvetica 20", relief="raised", command=quiz3).place(x=1000,
                                                                                                             y=550)
...
def quiz3():
    ...
    l67 = Label(frameG, text="3. Are you interested in \n developing new theories?", fg="#0BB0F6",
                font=("Arial", 50, "bold")).place(x=150, y=30)
    bCY = Button(frameG, command=comY).place(x=100, y=250)
    b87 = Button(frameG, text='A. YES', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                 command=click5).place(x=300, y=400)
    b88 = Button(frameG, text='B. NO', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                 command=click6).place(x=1000, y=400)
    bVY = Button(frameG, command=lambda: voiceY()).place(x=100, y=200)
    b89 = Button(frameG, text="Next", fg="Black", font="Helvetica 20", relief="raised", command=quiz4).place(x=1000,
                                                                                                             y=550)
...
def quiz4():
    ...
    l68 = Label(frameH, text="4. Are you interested in learning skills \n based upon problem solving.", fg="#0BB0F6",
                font=("Arial", 50, "bold")).place(x=150, y=30)
    bCZ = Button(frameH, command=comZ).place(x=100, y=250)
    b99 = Button(frameH, text='A. YES', fg="white", bg="red", font="Helvetica 35 bold", relief="raised",
                 command=click8).place(x=300, y=400)
    b98 = Button(frameH, text='B. NO', fg="white", bg="purple", font="Helvetica 35 bold", relief="raised",
                 command=click7).place(x=1000, y=400)
    bVZ = Button(frameH, command=lambda: voiceZ()).place(x=100, y=200)
    b96 = Button(frameH, text="Next", fg="Black", font="Helvetica 20", relief="raised", command=result).place(x=1000,
                                                                                                              y=550)
...
def result():
    ...
    l45 = Label(frameI, text="The Course You Should Choose is:", fg="#0BB0F6", font=("Arial", 50, "bold")).place(x=200,
                                                                                                                 y=30)
    eng = engg.get()
    app = applied.get()
    if eng == app:
    ...
    b45 = Button(frameI, text="Home", fg="Black", font="Helvetica 20", relief="raised", command=org).place(x=1200,
                                                                                                           y=600)
